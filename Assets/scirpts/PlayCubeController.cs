...
public class PlayCubeController : MonoBehaviour
{
    ...
    [SerializeField] FinishPoint _finishPoint;
    ...
    private MouseActionState _mouseActionState = new MouseActionState() { IsHoverHandled = true, IsMouseOver = false, IsBtnHolded = false };
    ...
    public PlayCubeState GetState() { return _state; }

    public Vector3 GetInitPosition() { return _initPosition; }
    ...
    private bool TryHandleDrag()
    {
        ...
        if (Input.GetMouseButtonUp(0) && _mouseActionState.IsBtnHolded)
        {
            ...
            _rigidbody.angularVelocity = new Vector3(distanceFromInit * _angularVelocityDropCoefficient, distanceFromInit * _angularVelocityDropCoefficient, distanceFromInit * _angularVelocityDropCoefficient);
        ...
        if (_mouseActionState.IsBtnHolded)
        {
            ...
            var newPositionVector = (_currentPosition - _initPosition) * -1 * distanceFromInit + _initPosition;

            _aim.transform.position = newPositionVector;
    ...
    {
        _returnToInitPositionDeltaTime += Time.deltaTime;
        ...
        //_currentPosition = Vector3.Lerp(_currentPosition, _initPosition, Time.deltaTime * _riseUpSpeed);
